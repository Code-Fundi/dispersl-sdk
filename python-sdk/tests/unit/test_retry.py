...
from dispersl.retry import retry_with_backoff, CircuitBreaker, CircuitBreakerOpenError
from dispersl.exceptions import TimeoutError, NetworkError, ServerError
...
class TestRetryLogic:
    ...
    def test_retry_on_specific_exceptions(self):
        ...
        @retry_with_backoff(
            max_retries=2,
            retry_on_exceptions={TimeoutError, NetworkError}
        )
